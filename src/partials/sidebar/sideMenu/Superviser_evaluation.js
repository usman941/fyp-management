...
const Superviser_evaluation = () => {
    ...
    const column = useMemo(() => [
      ...
      
        {
            ...
            :''}
                ...
                <EditCell path={'/evaluation/evaluate-superviser/'+person?.groupId}/>
             </>
            :''}
    ...
    return (
        ...
        <Detail title={'Superviser Evaluation'} column={column} data={filterFunction(search,persons)} search={search} setSearch={setSearch}>
...
export default Superviser_evaluation
