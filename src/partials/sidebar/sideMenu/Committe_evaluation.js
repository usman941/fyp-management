...
const Committe_evaluation = () => {
    ...
    const column = useMemo(() => [
        ...
        },
        {
            ...
            :''}
                ...
                <EditCell path={'/committe/evaluate/'+person?._id}/>
             </>
            :''}
    ...
    return (
        ...
        <Detail title={'Committe Evaluation'} column={column} data={filterFunction(search,persons)} search={search} setSearch={setSearch}>
...
export default Committe_evaluation
