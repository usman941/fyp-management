...
const IndustryPerson = () => {
    ...
    useEffect(() => {
        getPersons().then(data => {
            ...
            setPersons(data.IndustryPersons)
        })
    }, [])

    const url = 'http://localhost:3000/user/getAllIndustryPerson'
    ...
    return (
        ...
        <Detail title={'Industry Persons'} column={column} data={filterFunction(search,persons)} search={search} setSearch={setSearch}>
