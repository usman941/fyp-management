...
const Adviser = () => {
    ...
    useEffect(() => {
        getPersons().then(data => {
            ...
            setPersons(data.Advisors)
        })
    }, [])

    const url = 'http://localhost:3000/user/getAllAdvisors'
    ...
    return (
        ...
        <Detail title={' Advisors'} column={column} data={filterFunction(search,persons)} search={search} setSearch={setSearch}>
