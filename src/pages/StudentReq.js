...
// handle setPerson members array
    ...
    const addPersonHandler = async () => {
        await axios.post("http://localhost:3000/group/requestAssignment", {
    ...
    return (
        <div>
            ...
            <div className='flex mb-2'>
                <h1>Request for superviser and project idea</h1>
            </div>
            ...
            >
              {
                ...
                <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-8 py-2.5 mr-2 mb-2  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">{isUpdate ? 'Update' : 'Request'}</button>
